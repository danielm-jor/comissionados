...
**Servidores de livre provimento**: Cargos sobre os quais o chefe do Executivo pode dispor livremente, contratando ou demitindo seus ocupantes no momento que desejar. São cargos que dependem de confiança, normalmente de direção, chefia ou assessoramento.
...
O primeiro passo, portanto, foi o tratamento da base de dados, de modo a unificar os microdados e gerar unidades passíveis de análise. Abaixo, explico o passo-a-passo para obtenção e análise dos dados. As etapas farão referência a linhas específicas no script disponibilizado neste repositório.
